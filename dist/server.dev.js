...
var _require2 = require("./services/shadowEmailService"),
    processShadowEmailQueue = _require2.processShadowEmailQueue;

var cron = require("node-cron"); // Trigger restart 16
...
var server = app.listen(port, function () {
  ...
  cron.schedule("15 10 * * 2-4", function _callee2() {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return regeneratorRuntime.awrap(processShadowEmailQueue());
          ...
          case 6:
            ...
            console.error("Shadow email queue processing failed:", _context2.t0);
